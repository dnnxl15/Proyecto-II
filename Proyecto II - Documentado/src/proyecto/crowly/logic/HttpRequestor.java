...
public class HttpRequestor implements IConstants
{
	...
	{
		VideoResponse Result = null; //the variable of the VideoResponse type is equal to null
		HttpClient Httpclient = HttpClients.createDefault(); //create a new HttpClient
        try
        {
	...
	public static VideoResponse get(VideoResponse pVideoResponse, String pMSKey) //get the Video Response from the Http
	{
